...
import com.bank.webfluxpatterns.orchestratorparallel.dto.InventoryResponse;
...
public class InventoryClient {
    ...
    public InventoryClient(@Value("${orchestratorparallel.inventory.service}") String baseUrl){
