...
import com.bank.webfluxpatterns.orchestratorparallel.dto.ShippingResponse;
...
public class ShippingClient {
    ...
    public ShippingClient(@Value("${orchestratorparallel.shipping.service}") String baseUrl){
